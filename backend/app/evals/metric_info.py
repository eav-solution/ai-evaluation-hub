...
METRIC_INFO: dict[str, MetricInfo] = {
    "ragas.faithfulness": {
        ...
        "examples": [
            _example(
                "Fully supported",
                [
                    ("Context", "Paris is France's capital. The Eiffel Tower is in Paris."),
                    ("Answer", "Paris is France's capital and home to the Eiffel Tower."),
                ],
            ...
            _example(
                ...
                [
                    ...
                    ("Answer", "Paris is France's capital and hosted the 2012 Olympics."),
                ],
        ...
        "improvement_tips": _tips(
            ("Retrieval", "Remove irrelevant or conflicting contexts and add reranking."),
            ("Generation", "Require answers to use supplied evidence and abstain when it is missing."),
    ...
    "ragas.answer_relevancy": {
        ...
        "examples": [
            _example(
                "Direct answer",
                [("Input", "What is the capital of France?"), ("Answer", "Paris is the capital of France.")],
                [("pass", "The reverse-generated question matches the input intent.")],
                "High semantic similarity -> high score",
            ),
            _example(
                "Off-topic answer",
                [("Input", "What is the capital of France?"), ("Answer", "France has many historic cities and museums.")],
                [("fail", "The reverse-generated question does not identify the requested capital.")],
                "Low semantic similarity -> low score",
            ),
        ],
        "improvement_tips": _tips(
            ("Generation", "Answer the requested intent directly before adding supporting detail."),
    ...
    "ragas.context_precision": {
        ...
        "examples": [
            _example(
                ...
                [("pass", "The relevant chunk is ranked first."), ("neutral", "Noise appears later.")],
                "Relevant-first ranking -> high precision",
            ),
            _example(
                "Noise first",
                [("Contexts", "[unrelated travel note, Paris is the capital]")],
                [("fail", "Noise is ranked before evidence."), ("pass", "The evidence is eventually retrieved.")],
                "Late relevant chunk -> lower precision",
            ),
        ],
        "improvement_tips": _tips(
            ("Retrieval", "Add a reranker and tune top-k to prioritize the strongest evidence."),
            ("Data", "Improve chunk boundaries and remove duplicate or boilerplate chunks."),
        ),
    ...
    "ragas.context_recall": {
        ...
        "examples": [
            _example(
                "Complete retrieval",
                [("Reference", "Paris is France's capital and the Eiffel Tower opened in 1889."), ("Contexts", "Both facts are present.")],
                [("pass", "Capital claim supported."), ("pass", "Opening-year claim supported.")],
                "2 / 2 supported = 1.00",
            ),
            _example(
                "Missing evidence",
                [("Reference", "Paris is France's capital and the Eiffel Tower opened in 1889."), ("Contexts", "Only the capital fact is present.")],
                [("pass", "Capital claim supported."), ("fail", "Opening-year claim missing.")],
                "1 / 2 supported = 0.50",
            ),
        ],
        "improvement_tips": _tips(
            ("Retrieval", "Increase coverage with query rewriting, hybrid search, or a larger top-k."),
            ("Data", "Add missing documents and use chunks that preserve complete facts."),
        ),
        "required_data": ["input", "expected_output", "contexts"],
    },
    "deepeval.answer_relevancy": {
        ...
        "examples": [
            _example(
                "Focused response",
                [("Input", "How do I reset my password?"), ("Answer", "Open Settings, choose Security, then select Reset password.")],
                [("pass", "Every statement helps answer the reset question.")],
                "All statements relevant -> 1.00",
            ),
            _example(
                "Distracted response",
                [("Input", "How do I reset my password?"), ("Answer", "Open Security to reset it. Our company was founded in 2019.")],
                [("pass", "Reset instruction is relevant."), ("fail", "Company history is irrelevant.")],
                "1 / 2 relevant = 0.50",
            ),
        ],
        "improvement_tips": _tips(
            ("Generation", "Constrain the response to information needed by the user's request."),
            ("Prompt", "Ask for concise answers and explicitly reject unrelated detail."),
        ),
        "required_data": ["input", "actual_output"],
    },
    "deepeval.faithfulness": {
        ...
        "examples": [
            _example(
                "Grounded answer",
                [("Retrieval context", "The warranty lasts two years."), ("Answer", "The warranty lasts two years.")],
                [("pass", "The duration matches the retrieval context.")],
                "1 / 1 truthful = 1.00",
            ),
            _example(
                "Unsupported addition",
                [("Retrieval context", "The warranty lasts two years."), ("Answer", "The warranty lasts two years and covers accidental damage.")],
                [("pass", "Duration is supported."), ("fail", "Accidental-damage coverage is unsupported.")],
                "1 / 2 truthful = 0.50",
            ),
        ],
        "improvement_tips": _tips(
            ("Generation", "Force grounding in retrieved context and allow an insufficient-evidence response."),
    ...
    "deepeval.hallucination": {
        ...
        "examples": [
            _example(
                "No contradiction",
                [("Context", "The trial lasted six weeks."), ("Answer", "The trial lasted six weeks.")],
                [("pass", "The answer agrees with the context.")],
                "0 / 1 contradicted = 0.00",
            ),
            _example(
                "Contradiction",
                [("Context", "The trial lasted six weeks."), ("Answer", "The trial lasted two weeks.")],
                [("fail", "The stated duration contradicts the context.")],
                "1 / 1 contradicted = 1.00",
            ),
        ],
        "improvement_tips": _tips(
            ("Generation", "Require evidence-backed answers and abstention when trusted context is insufficient."),
    ...
    "deepeval.toxicity": {
        ...
        "examples": [
            _example(
                "Respectful response",
                [("Answer", "I disagree, but your evidence raises an important question.")],
                [("pass", "The disagreement is respectful.")],
                "0 / 1 toxic = 0.00",
            ),
            _example(
                "Hostile response",
                [("Answer", "Your idea is worthless and only an idiot would suggest it.")],
    ...
    "deepeval.bias": {
        ...
        "examples": [
            _example(
                "Neutral response",
                [("Answer", "The candidate's experience should be assessed against the role requirements.")],
                [("pass", "The assessment avoids group stereotypes.")],
                "0 / 1 biased = 0.00",
            ),
            _example(
                "Stereotyped response",
                [("Answer", "This candidate must be good at math because of their ethnicity.")],
                [("fail", "The opinion uses an ethnic stereotype.")],
                "1 / 1 biased = 1.00",
            ),
        ],
        "improvement_tips": _tips(
            ("Safety", "Add fairness rules and review outputs for protected-group stereotypes."),
            ("Data", "Balance examples and remove biased associations from fine-tuning data."),
        ),
        "required_data": ["input", "actual_output"],
    },
    "deepeval.geval": {
        ...
        "examples": [
            _example(
                ...
                [("Rubric", "The answer should be clear and concise."), ("Answer", "Restart the service, then verify its health endpoint.")],
                [("pass", "The response is direct and actionable.")],
                "Strong rubric alignment -> high score",
            ),
            _example(
                "Misses a clarity rubric",
                [("Rubric", "The answer should be clear and concise."), ("Answer", "There are many possibilities, considerations, and things that might happen.")],
                [("fail", "The response is vague and not actionable.")],
                "Weak rubric alignment -> low score",
            ),
        ],
        "improvement_tips": _tips(
            ("Rubric", "Write one specific quality criterion with observable expectations."),
            ("Generation", "Align the system prompt and few-shot examples with the rubric."),
            ("Evaluation", "Use representative examples to validate that the rubric scores as intended."),
        ),
        "required_data": ["input", "actual_output"],
    },
}
